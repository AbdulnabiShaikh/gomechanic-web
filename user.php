		...
		<div id="site-content">
			...
			<header class="site-header">
				<div class="container">
					...
					<nav class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item current-menu-item"><a href="user.php">Home</a></li>
							<li class="menu-item"><a href="aboutuser.php">About</a></li>
							<li class="menu-item"><a href="mechanic.php">Get Mechanic</a></li>
			...
			<main class="main-content">
				<div class="hero hero-slider">
					<ul class="slides">
						<li data-bg-image="pics/parts.png" style="background-size: cover;">
							<div class="container">
						...
						<li data-bg-image="pics/mecparts2.png" style="background-size: cover;">
							<div class="container">
						...
						<li data-bg-image="pics/mecparts.png" style="background-size: cover;">
							<div class="container">
